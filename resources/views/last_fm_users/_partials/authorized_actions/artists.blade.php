<div class="col-md-6">
    ...
    <fieldset {{ $artists->count() !== 0 ?: 'disabled' }}>
        ...
        <div class="tooltip-wrapper"
             data-title="{{ $artists->count() === 0 ? 'Import from file' : 'Delete LastFm Artists listened first'}}">
...
<div class="col-md-6">
    <fieldset {{ $artists->count() === 0 ?: 'disabled' }}>
        ...
        <div class="form-group">
            <div class="tooltip-wrapper"
                 data-title="{{ $artists->count() === 0 ? 'Delete All LastFm Users Artists' : 'No LastFm Users
